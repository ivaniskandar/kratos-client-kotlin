...
class OAuth2ClientTest : ShouldSpec() {
    init {
        ...
        // to test the property `authorizationCodeGrantAccessTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        ...
        // to test the property `authorizationCodeGrantIdTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        should("test authorizationCodeGrantIdTokenLifespan") {
            // uncomment below to test the property
            //modelInstance.authorizationCodeGrantIdTokenLifespan shouldBe ("TODO")
        }

        // to test the property `authorizationCodeGrantRefreshTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        ...
        // to test the property `clientCredentialsGrantAccessTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        ...
        // to test the property `implicitGrantAccessTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        should("test implicitGrantAccessTokenLifespan") {
            // uncomment below to test the property
            //modelInstance.implicitGrantAccessTokenLifespan shouldBe ("TODO")
        }

        // to test the property `implicitGrantIdTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        ...
        // to test the property `jwtBearerGrantAccessTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        ...
        // to test the property `refreshTokenGrantAccessTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        should("test refreshTokenGrantAccessTokenLifespan") {
            // uncomment below to test the property
            //modelInstance.refreshTokenGrantAccessTokenLifespan shouldBe ("TODO")
        }

        // to test the property `refreshTokenGrantIdTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
        should("test refreshTokenGrantIdTokenLifespan") {
            // uncomment below to test the property
            //modelInstance.refreshTokenGrantIdTokenLifespan shouldBe ("TODO")
        }

        // to test the property `refreshTokenGrantRefreshTokenLifespan` - Specify a time duration in milliseconds, seconds, minutes, hours.
