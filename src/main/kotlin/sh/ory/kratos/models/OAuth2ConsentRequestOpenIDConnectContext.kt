...
data class OAuth2ConsentRequestOpenIDConnectContext (
    ...
    @SerialName(value = "acr_values")
    val acrValues: kotlin.collections.List<kotlin.String>? = null,
    ...
    @Contextual @SerialName(value = "id_token_hint_claims")
    val idTokenHintClaims: kotlin.collections.Map<kotlin.String, JsonObject>? = null,
