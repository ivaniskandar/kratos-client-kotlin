...
data class UpdateRegistrationFlowWithOidcMethod (
    ...
    @SerialName(value = "id_token_nonce")
    val idTokenNonce: kotlin.String? = null,
    ...
    @Contextual @SerialName(value = "upstream_parameters")
    val upstreamParameters: JsonObject? = null
